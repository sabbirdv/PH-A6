...
const TodaysCard = ({data}) => {
    ...
    const handleCloseButton= ()=>{
        setTodaysData(todaysData.filter((element)=> element.id !== data.id))
    }
    ...
    return (
        <div>
            ...
            <div className="flex items-center gap-3">
                ...
                <button className= "btn flex items-center gap-1 px-5 py-2 rounded-full bg-[#C6FF00] text-black text-sm font-semibold cursor-pointer shadow-none border-none disabled:bg-gray-300 "
